      ...
      {!cohort && !error && (
        ...
        >
          <h3 style={{ fontWeight: 700, fontSize: "1rem", color: "#b45309", marginBottom: "0.75rem", display: "flex", alignItems: "center", gap: "0.5rem" }}>
            ⚠️ ต้องสร้างรุ่นก่อนนำเข้าสมาชิก
          </h3>
          <p style={{ fontSize: "0.875rem", color: "#92400e", marginBottom: "1rem", lineHeight: 1.7 }}>
            คุณยังไม่สามารถนำเข้าสมาชิกได้ เนื่องจากยังไม่มีข้อมูลรุ่น (Cohort) ในระบบ กรุณาทำตามขั้นตอนต่อไปนี้:
          </p>
          <ol style={{ margin: 0, paddingLeft: "1.25rem", fontSize: "0.875rem", color: "#92400e", lineHeight: 1.8 }}>
            <li><strong>ขั้นตอนที่ 1:</strong> ไปที่หน้า <a href="/admin/organization" style={{ color: "#2563eb", textDecoration: "underline", fontWeight: 600 }}>องค์กร</a> เพื่อสร้างข้อมูลองค์กร</li>
            <li><strong>ขั้นตอนที่ 2:</strong> สร้างรุ่น (เช่น CPE30) โดยกดปุ่ม "สร้างรุ่นใหม่"</li>
            <li><strong>ขั้นตอนที่ 3:</strong> กลับมาที่หน้านี้เพื่อนำเข้าสมาชิกด้วย Smart Import</li>
          </ol>

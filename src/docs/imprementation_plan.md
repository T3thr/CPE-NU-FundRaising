...
6. /pay/[cohort-slug] - หน้าแจ้งชำระเงิน
...
7. /status/[student-id] - เช็คสถานะการชำระ
...
15. Monthly Cron Job (Supabase Edge Function)
    ...
    │ ├── line-messaging/route.ts # Send notifications (LINE Messaging API 2026)
